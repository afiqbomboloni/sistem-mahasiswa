...
@section('content')
@if (count($data_mahasiswa))
<div class="container mt-3">
    <div>Ditemukan {{ count($data_mahasiswa) }} data dengan kata: {{ $find }}</div>
    ...
    <form action="{{ route('mahasiswa.search') }}" method="GET">@csrf
        <div class="form-group mt-5">
            <input type="text" name="word" placeholder="Cari Nama Mahasiswa">
        </div>
    ...
    @else
        <div class="container"><h4>Data {{ $find }} tidak ditemukan</h4>
